...
- PostgreSQL (including [TimescaleDB](https://www.timescale.com/), [pgvecto.rs](https://github.com/tensorchord/pgvecto.rs), Nextcloud's [AIO](https://github.com/nextcloud/all-in-one), and [pgautoupgrade](https://github.com/pgautoupgrade/docker-pgautoupgrade))
- Redis
